...
- [Element Types](anchoring/element-types.html) — which block elements can be anchored and how indexes are calculated
- [Drift Detection](anchoring/drift-detection.html) — what happens to comments when the document changes
